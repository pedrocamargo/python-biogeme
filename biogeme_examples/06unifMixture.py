...
# Define a random parameter designed to be used for Monte-Carlo simulation
...
# The random parameter is uniformly distributed
BIOGEME_OBJECT.DRAWS = { 'B_TIME_RND': 'UNIFORMSYM' }
