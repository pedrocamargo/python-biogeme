...
V1 = ASC_TRAIN + B_TIME * (TRAIN_TT_SCALED**LAMBDA-1)/LAMBDA + B_COST * TRAIN_COST_SCALED
V2 = ASC_SM + B_TIME * (SM_TT_SCALED**LAMBDA-1)/LAMBDA + B_COST * SM_COST_SCALED
V3 = ASC_CAR + B_TIME * (CAR_TT_SCALED**LAMBDA-1)/LAMBDA + B_COST * CAR_CO_SCALED
