...
ASC_CAR = Beta('ASC_CAR',-0.895,-10,10,0)
ASC_TRAIN = Beta('ASC_TRAIN',-1.98,-10,10,0)
ASC_SM = Beta('ASC_SM',0,-10,10,1)
B_TIME = Beta('B_TIME',-3.18,-10,10,0)
B_COST = Beta('B_COST',-3.06,-10,10,0)
SIGMA_CAR = Beta('SIGMA_CAR',4.39,-10,10,0)
SIGMA_SM = Beta('SIGMA_SM',0,-10,10,1)
SIGMA_TRAIN = Beta('SIGMA_TRAIN',3.55,-10,10,0)
