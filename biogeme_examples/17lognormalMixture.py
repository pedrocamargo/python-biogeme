...
ASC_TRAIN = Beta('ASC_TRAIN',-0.345864,-10,10,0,'ASC_TRAIN' )
B_TIME = Beta('B_TIME',0.575765,-5,1,0,'B_TIME' )
B_TIME_S = Beta('B_TIME_S',1.2393,-10,10,0,'B_TIME_S' )
B_COST = Beta('B_COST',-1.38051,-10,10,0,'B_COST' )
ASC_SM = Beta('ASC_SM',0,-10,10,1,'ASC_SM' )
ASC_CAR = Beta('ASC_CAR',0.17457,-10,10,0,'ASC_CAR' )

# Define a random parameter, log normally distirbuted, designed to be used
# for Monte-Carlo simulation
B_TIME_RND = -exp(B_TIME + B_TIME_S * bioDraws('B_TIME_RND'))
