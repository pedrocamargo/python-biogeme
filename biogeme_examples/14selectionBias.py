...
ASC_TRAIN = Beta('ASC_TRAIN',0,-100,100,0)
...
# based sampling
SB_TRAIN =  Beta( 'SB_TRAIN', 0, -100, 100, 0)
...
Gi = getMevForNested(V,av,nests)
logprob = logmev_selectionBias(V,Gi,av,correction,CHOICE)
