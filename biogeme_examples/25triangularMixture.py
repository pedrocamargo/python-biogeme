...
# Date: Wed May 20 18:53:17 2015
#  Compliant with the syntax of version 2.4
#
#######################################
...
B_TIME_S = Beta('B_TIME_S',0,-10,10,0)
...
# Define draws used for Monte-Carlo simulation.
BIOGEME_OBJECT.DRAWS = { 'BUNIF1': 'UNIFORMSYM', 'BUNIF2': 'UNIFORMSYM'}
# Define a random parameter following a triangular distribution
# designed to be used for Monte-Carlo simulation

TRIANG = DefineDraws('TRIANG', 0.5 * (bioDraws('BUNIF1')+bioDraws('BUNIF2')),'obsIter')
B_TIME_RND = B_TIME + B_TIME_S * TRIANG
